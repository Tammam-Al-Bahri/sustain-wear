        ...
        <>
            <div className="flex flex-col gap-[30px] w-full pt-14 pb-7">
                <div className="flex flex-col gap-4">
                    <h1 className="text-[32px]/9 text-center font-medium text-green-700 dark:text-white">
                        Donate Your Clothes.
                        <br />
                        <i className="font-extrabold"> Make an Impact.</i>
                    </h1>
                    <p className="text-[16px] text-center font-light text-green-500 dark:text-white">
